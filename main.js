...
function main() {
    ...
    client.on("message", (message) => {
        ...
        } else if (message.content.includes('ôi bạn ơi')) {
        ...
        } else if (message.content.includes('không làm mà đòi có ăn')) {
        ...
        } else if (message.content.includes('bạn tốt')) {
        ...
        } else if (message.content.includes('anh em tốt')) {
        ...
        } else if (message.content.includes('nói xấu người khác')) {
        ...
        } else if (message.content.includes('anh bạn à')) {
            message.reply({ 
